...
public class FormsPage {
	...
	// ================ COMMON METHODS TO CREATE AND DELETE ==================
	...
	// ================= METHODS RELATED TO CREATE A FORM ====================
	...
	// ================= METHODS RELATED TO DELETE A FORM ====================
	...
	public void sucessMessageAfterCreate() {
		waitElement(_sucessMessageAfterCreateLocator);
		DRIVER.findElement(_sucessMessageAfterCreateLocator);
		assertTrue(DRIVER.findElement(_sucessMessageAfterCreateLocator).isDisplayed());
	}
	
	public void closeSucessMessageAfterDelete() {
	...
	private final By _sucessMessageAfterCreateLocator = By
			.xpath("//*[@class='yui3-widget-bd' and contains (text(), 'The form was published successfully!')]");
